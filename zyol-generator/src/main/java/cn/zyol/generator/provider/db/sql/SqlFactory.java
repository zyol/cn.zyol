package cn.zyol.generator.provider.db.sql;

import cn.zyol.generator.provider.db.sql.model.Sql;
import cn.zyol.generator.provider.db.sql.model.SqlParameter;
import cn.zyol.generator.provider.db.table.TableFactory;
import cn.zyol.generator.provider.db.table.TableFactory.NotFoundTableException;
import cn.zyol.generator.provider.db.table.model.Column;
import cn.zyol.generator.provider.db.table.model.Table;
import cn.zyol.generator.util.BeanHelper;
import cn.zyol.generator.util.GLogger;
import cn.zyol.generator.util.StringHelper;
import cn.zyol.generator.util.sqlparse.NamedParameterUtils;
import cn.zyol.generator.util.sqlparse.ParsedSql;
import cn.zyol.generator.util.sqlparse.ResultSetMetaDataHolder;
import cn.zyol.generator.util.sqlparse.SqlParseHelper;
import cn.zyol.generator.util.sqlparse.SqlParseHelper.NameWithAlias;
import cn.zyol.generator.util.typemapping.JdbcType;
