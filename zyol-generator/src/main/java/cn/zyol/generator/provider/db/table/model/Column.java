package cn.zyol.generator.provider.db.table.model;


import cn.zyol.generator.GeneratorProperties;
import cn.zyol.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import cn.zyol.generator.provider.db.table.model.util.ColumnHelper;
import cn.zyol.generator.util.GLogger;
import cn.zyol.generator.util.StringHelper;
import cn.zyol.generator.util.TestDataGenerator;
import cn.zyol.generator.util.typemapping.ActionScriptDataTypesUtils;
import cn.zyol.generator.util.typemapping.DatabaseDataTypesUtils;
import cn.zyol.generator.util.typemapping.JavaPrimitiveTypeMapping;
